...
export const MyProfile: React.FC<MyProfileProps> = ({ currentUser, onUpdateUser }) => {
  ...
  const applyResizedAvatar = async () => {
    if (!adjustImageSrc) return;

    const finalAvatarUrl = await new Promise<string>((resolve) => {
      const img = new Image();
  ...
  return (
    <div className="relative overflow-hidden min-h-screen max-w-6xl mx-auto bg-gradient-to-br from-[#FFF8F2] via-[#FFF4EC] via-60% to-[#F8FAFC] dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 p-4 sm:p-8 rounded-3xl transition-colors">
      ...
      {/* Adjust Profile Picture Size Modal */}
      {showAdjustModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/70 backdrop-blur-sm animate-in fade-in">
          <div className="bg-white dark:bg-slate-900 rounded-3xl max-w-md w-full p-6 shadow-2xl space-y-5 border border-slate-200 dark:border-slate-800 text-center">
            ...
            <div className="space-y-3 px-4 pt-2">
              <div className="flex items-center justify-between text-xs font-bold text-slate-700 dark:text-slate-300">
                ...
                <span className="px-2.5 py-1 rounded-full bg-[#FFF4EA] text-[#E96B1A] font-extrabold text-xs border border-[#F28C28]/30">
                  {zoomScale}% Zoom
                </span>
                <span className="flex items-center gap-1">
              ...
              <input
                ...
                className="w-full h-2 bg-slate-200 dark:bg-slate-700 rounded-lg appearance-none cursor-pointer accent-[#F28C28]"
              />
              ...
              <div className="flex justify-center gap-2 pt-1">
                <button
                  ...
                  className="px-3 py-1 rounded-lg bg-slate-100 dark:bg-slate-800 text-xs font-bold text-slate-700 dark:text-slate-300 hover:bg-slate-200"
                >
                  - 10%
                </button>
                <button
                  ...
                  className="px-3 py-1 rounded-lg bg-slate-100 dark:bg-slate-800 text-xs font-bold text-slate-700 dark:text-slate-300 hover:bg-slate-200 flex items-center gap-1"
                >
            ...
            <div className="pt-4 border-t border-slate-100 dark:border-slate-800 flex items-center justify-end gap-3">
              ...
              <button
                type="button"
                onClick={applyResizedAvatar}
                className="px-5 py-2 rounded-xl bg-[#F28C28] hover:bg-[#E96B1A] text-white text-xs font-bold shadow-md transition-all flex items-center gap-1.5 cursor-pointer"
              >
