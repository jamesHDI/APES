...
export const SEED_USERS: User[] = [
  ...
  {
    id: 'usr_john_laurence',
    employeeNumber: 'EMP-1008',
    firstName: 'John Laurence',
    middleName: '',
    lastName: 'Fabrero',
    name: 'John Laurence Fabrero',
    email: 'johnlaurence.fabrero@gmail.com',
    username: 'johnlaurence.fabrero',
    password: '123456',
    contactNumber: '',
    role: 'system_admin',
    departmentId: 'dept_adm',
    departmentName: 'Admin',
    position: 'System Administrator / Lead Developer',
    employmentStatus: 'Regular',
    dateHired: '2024-01-01',
