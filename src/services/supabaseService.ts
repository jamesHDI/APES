...
export const saveEvaluationTemplateToSupabase = async (template: EvaluationTemplate): Promise<boolean> => {
  ...
  try {
    ...
    const fullPayload = {
      ...
      deployedAt: template.deployedAt,
  ...
  try {
    ...
    const templates: EvaluationTemplate[] = rows.map((row: any) => {
      ...
      return {
        ...
        createdForEmployeeId: full.createdForEmployeeId || row.created_for_employee_id || undefined,
        createdForEmployeeName: full.createdForEmployeeName || row.created_for_employee_name || undefined,
        createdForEmployeeNumber: full.createdForEmployeeNumber || row.created_for_employee_number || undefined,
        createdForPosition: full.createdForPosition || row.created_for_position || undefined,
        immediateSupervisorId: full.immediateSupervisorId || row.immediate_supervisor_id || undefined,
        immediateSupervisorName: full.immediateSupervisorName || row.immediate_supervisor_name || undefined,
